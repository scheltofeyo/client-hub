...
export default async function TeamToolPage({
  searchParams,
}: {
  ...
  if (!hasPermission(session, "team.viewCalendar")) redirect("/tools");
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <PageHeader
        breadcrumbs={[{ label: "Tools", href: "/tools" }, { label: "Holiday Planner" }]}
